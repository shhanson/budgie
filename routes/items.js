...
router.get('/receipts/:receipt_id/items', (req, res, next) => {
...
router.patch('/receipts/:receipt_id/items/:id', (req, res, next) => {
...
router.delete('/receipts/:receipt_id/items/:id', (req, res, next) => {
